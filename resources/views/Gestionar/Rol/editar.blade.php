...
@section('contenido') 
  ...
  @endif
    <form action="{{url('/rol/editar/'.$rol->id)}}"  method="POST" enctype="multipart/form-data">
      @csrf
      <div class="form-group">
      <label >Nombre del rol :</label>
      <input name="nombre" value="{{$rol->nombre}}" type="text" class="form-control">
      </div>
      <div class="form-group">
          ...
          <div class="col">
            ...
            <div class="p-3 form-group border">
                ...
                <div class="pb-3 custom-control custom-checkbox">
                  <input name="producto" @foreach($rol->rolacciones as $accion) @if(! empty($accion) ) @if($accion->idaccion == 1 && $accion->eliminado==0) checked="true" @endif  @endif @endforeach value="1" type="checkbox" class="custom-control-input gestionar" id="customCheck1">
                ...
                <div class="custom-control custom-checkbox">
                  <input name="pedido" value="2" @foreach($rol->rolacciones as $accion) @if(! empty($accion) ) @if($accion->idaccion == 2 && $accion->eliminado==0) checked="true" @endif  @endif @endforeach type="checkbox" class="custom-control-input gestionar" id="customCheck2">
            ...
            <div class="p-3 form-group border">
              ...
              <div id="checkGestionar">
                <div class="row d-flex justify-content-around">
                  ...
                  <div class="custom-control custom-checkbox">
                    <input name="privilegio[0]" value="2" @foreach($rol->rolprivilegioes as $privilegio) @if(! empty($privilegio) ) @if($privilegio->idprivilegio == 2 && $privilegio->eliminado==0) checked="true" @endif  @endif @endforeach type="checkbox" class="custom-control-input gestion" id="customCheck4">
                    <label class="custom-control-label" for="customCheck4"><h5><span class="badge badge-primary">Buscar</span></h5></label>
                  </div>
                  <div class="custom-control custom-checkbox">
                    <input name="privilegio[1]" value="3" @foreach($rol->rolprivilegioes as $privilegio) @if(! empty($privilegio) ) @if($privilegio->idprivilegio == 3 && $privilegio->eliminado==0) checked="true" @endif  @endif @endforeach type="checkbox" class="custom-control-input gestion" id="customCheck5">
                ...
                <div class="mb-1 row d-flex justify-content-around">
                  <div class="custom-control custom-checkbox">
                    <input name="privilegio[2]" value="4" @foreach($rol->rolprivilegioes as $privilegio) @if(! empty($privilegio) ) @if($privilegio->idprivilegio == 4 && $privilegio->eliminado==0) checked="true" @endif  @endif @endforeach type="checkbox" class="custom-control-input gestion" id="customCheck6">
                    <label class="custom-control-label" for="customCheck6"><h5><span class="badge badge-warning">Editar</span></h5></label>
                  </div>
                  <div class="custom-control custom-checkbox">
                    <input name="privilegio[3]" value="5" @foreach($rol->rolprivilegioes as $privilegio) @if(! empty($privilegio) ) @if($privilegio->idprivilegio == 5 && $privilegio->eliminado==0) checked="true" @endif  @endif @endforeach type="checkbox" class="custom-control-input gestion" id="customCheck7">
               ...
               {{--  Privilegios para gestionar pedido --}}
                <div id="checkPedido" class="pt-2 row d-flex justify-content-around border">
                  <div class="custom-control custom-checkbox">
                    <input name="privilegio[4]" value="6" @foreach($rol->rolprivilegioes as $privilegio) @if(! empty($privilegio) ) @if($privilegio->idprivilegio == 6 && $privilegio->eliminado==0) checked="true" @endif  @endif @endforeach type="checkbox" class="custom-control-input pedido" id="customCheck8">
                    <label class="custom-control-label" for="customCheck8"><h5><span class="badge badge-light">Asignar repartidor</span></h5></label>
                  </div>
                  <div class="custom-control custom-checkbox">
                    <input name="privilegio[5]" value="7" @foreach($rol->rolprivilegioes as $privilegio) @if(! empty($privilegio) ) @if($privilegio->idprivilegio == 7 && $privilegio->eliminado==0) checked="true" @endif  @endif @endforeach type="checkbox" class="custom-control-input pedido" id="customCheck9">
