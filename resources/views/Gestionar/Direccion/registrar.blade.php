        ...
        <form id="formularioDireccion">
            ...
            <div class="row">
              ...
              <div class="form-group col">
                ...
                <input name="calle" type="text" class="form-control" id="exampleInputPassword1">
          ...
          <br>
        <div id="map" data-latitud=""  data-longuitud=""  style="width: auto;height: 200px;"></div>
       ...
       event.preventDefault();
        ...
        console.log(longuitud);
         $.ajax({
          ...
          {
            if(response.success){
              window.location=`{{ url('direccion/listar') }}`;
            }else {
