...
@section('contenido') 
  ...
  @endif
    <form action="{{url('/subcategoria/editar/'.$subcategoria->id)}}"  method="POST" enctype="multipart/form-data">
      @csrf
      <div class="row">
        <div class="form-group col">
        <label >Nombre de la subcategoria :</label>
        <input name="nombre" value="{{ $subcategoria->nombre }}" type="text" class="form-control">
        </div>
      ...
      <div class="form-group">
        ...
        <input type="color" name="color" value="{{ $subcategoria->color }}" class="form-control">
      </div>
      <div class="form-group">
      ...
      <div class="form-group row">
          ...
          <div class="col">
            <label style="" class="form-group ">Vista previa :</label><br>
                        <img src="{{ '/storage/productos/'.$subcategoria->imagen }}"id="im" style="width:150px; height: 150px;">
          </div>
